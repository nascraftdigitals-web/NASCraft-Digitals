...
import { FiArrowRight, FiCalendar, FiClock, FiVideo, FiCheck, FiZap, FiUsers, FiTrendingUp } from 'react-icons/fi'
...
const BENEFITS = [
  { icon: <FiZap />, title: 'Free 30-Min Consultation', desc: 'No commitment, just honest advice' },
  { icon: <FiUsers />, title: 'Talk to Real Founders', desc: 'Direct access to our core team' },
  { icon: <FiTrendingUp />, title: 'Get a Custom Roadmap', desc: 'Tailored strategy for your project' },
]

const WHAT_TO_EXPECT = [
  'Quick intro and understanding your goals',
  'Review your current digital presence (if any)',
  'Discuss timeline, budget, and expectations',
  'Get a ballpark quote and next steps',
  'No sales pitch — just real conversation',
]
      ...
      <section className={styles.benefitsSection}>
        <div className="container">
          <div className={styles.benefitsGrid}>
            {BENEFITS.map((b, i) => (
              <div key={i} className={`${styles.benefitCard} reveal d${i+1}`}>
              ...
              <div className={styles.formGrid}>
                ...
                <div className={`${styles.details} reveal d2`}>
                  ...
                  <div className={styles.expectCard}>
                    <h3 className={styles.expectTitle}>What to Expect on the Call</h3>
